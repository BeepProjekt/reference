...
- [Grok CLI](https://cheatsheets.zip/grok-cli.html): [Grok CLI](https://www.grokcli.dev/docs/) is a conversational AI terminal tool powered by X.AI's Grok models, with file operations, code analysis, Plan Mode, and MCP support.
- [OpenCode](https://cheatsheets.zip/opencode.html): [OpenCode](https://opencode.ai) is an open-source AI coding agent with a TUI, CLI, and desktop app — supports any LLM provider, fully extensible via config, plugins, and MCP.
- [Claude Code](https://cheatsheets.zip/claude-code.html): [Claude Code](https://code.claude.com) is an agentic AI coding tool by Anthropic — reads your codebase, edits files, runs commands, and integrates with your development tools.
- [Cursor CLI](https://cheatsheets.zip/cursor-cli.html): [Cursor CLI](https://cursor.com/docs/cli/overview) (`agent`) is the terminal interface for Cursor's AI coding agent — run agentic tasks, scripts, and CI pipelines from the command line.
- [Gemini CLI](https://cheatsheets.zip/gemini-cli.html): [Gemini CLI](https://geminicli.com/docs/) brings Google Gemini models directly into your terminal for code understanding, task automation, and workflow building.
- [Codex CLI](https://cheatsheets.zip/codex-cli.html): OpenAI Codex CLI (v0.116+) is an open-source AI coding agent that reads, edits, and runs code directly in your terminal. See the [official docs](https://developers.openai.com/codex/cli) _(developers.openai.com)_.
- [Gemma 4](https://cheatsheets.zip/gemma4.html): [Gemma 4](https://deepmind.google/models/gemma/gemma-4/) is Google DeepMind's Apache 2.0 open-weights multimodal LLM family with frontier intelligence across four sizes, from mobile-edge to server-grade deployment.
- [OpenClaw](https://cheatsheets.zip/openclaw.html): [OpenClaw](https://openclaw.ai) is a self-hosted AI gateway that bridges WhatsApp, Telegram, Discord, iMessage, and more to AI coding agents.
...
- [Socket io](https://cheatsheets.zip/socket-io.html): Socket.IO is a JavaScript library for real-time web applications. It enables bi-directional, event-based communication between clients (typically browsers or native apps) and servers.
- [Nim](https://cheatsheets.zip/nim.html): The Nim quick reference cheat sheet that aims at providing help on writing basic syntax and methods.
...
- [Lua](https://cheatsheets.zip/lua.html): The [Lua](https://www.lua.org/) cheat sheet is a one-page reference sheet for the Lua 5.4 programming language.
- [Nix](https://cheatsheets.zip/nix.html): The Nix quick reference cheat sheet that aims at providing help on writing basic nix code.
- [Svelte](https://cheatsheets.zip/svelte.html): A Svelte cheat sheet with the most important concepts, functions, reactivity, and more. A complete quick reference for beginners, updated for Svelte 5.
- [Symfony](https://cheatsheets.zip/symfony.html): This Symfony Cheat Sheet is a non exhaustive list of main symfony basics that you can use or need.
- [Windows Cmd](https://cheatsheets.zip/windows-cmd.html): This Windows Command Cheat Sheet is a non-exhaustive list of the main Windows commands you can use.
- [Vue](https://cheatsheets.zip/vue.html): A Vue 3 cheat sheet with the most important concepts, reactivity, component system, routing, and more. Updated for the latest version and perfect for both beginners and advanced users.
- [HTMX](https://cheatsheets.zip/htmx.html): A modern, minimal JavaScript library that allows you to create dynamic web interfaces using HTML attributes.
- [Flask](https://cheatsheets.zip/flask.html): A concise cheatsheet for Flask, a lightweight WSGI web application framework for Python.
- [FastAPI](https://cheatsheets.zip/fastapi.html): A concise cheatsheet for FastAPI, a fast and modern web framework for building APIs with Python 3.7+.
- [OCaml](https://cheatsheets.zip/ocaml.html): The [OCaml](https://www.ocaml.org/) cheat sheet is a one-page reference sheet for the OCaml programming language.
...
- [Arduino Programming](https://cheatsheets.zip/arduino-programming.html): Ardunio programming cheat-sheet for I/O programming and  ardunio board programming.
- [HTML Canvas](https://cheatsheets.zip/canvas.html): This HTML  Canvas quick reference cheat sheet lists the common HTML5  Canvas design tags in readable layout.
- [TypeScript](https://cheatsheets.zip/typescript.html): A TypeScript cheat sheet with the most important concepts, functions, methods, and more. A complete quick reference for beginners.
- [Perl](https://cheatsheets.zip/perl.html): The perl quick reference cheat sheet that aims at providing help on writing basic syntax and methods.
- [Django](https://cheatsheets.zip/django.html): A Django cheat sheet.
- [Selenium](https://cheatsheets.zip/selenium.html): This cheat sheet is a crash course for Selenium beginners and help to get the idea about the basic concepts of Selenium.
- [Ruby](https://cheatsheets.zip/ruby.html): The [Ruby](https://www.ruby-lang.org/) cheat sheet is a one-page reference sheet for the Ruby programming language.
- [Terraform](https://cheatsheets.zip/terraform.html): This is a quick reference cheat sheet for [Terraform](https://docs.docker.com/get-started/).
...
- [React](https://cheatsheets.zip/react.html): A React cheat sheet with the most important concepts, functions, methods, and more. A complete quick reference for beginners.
...
- [npm](https://cheatsheets.zip/npm.html): A NPM (node package manager) cheat sheet with the most important concepts, and commands to install, update, and manage your node packages.
...
- [PowerShell](https://cheatsheets.zip/powershell.html): This is a quick reference cheat sheet to getting started with PowerShell scripting.
...
- [Color Picker](https://cheatsheets.zip/color-picker.html): The Color Picker  cheat sheet provides you basic color info and  choices
- [Github CLI](https://cheatsheets.zip/github-cli.html): A quick reference to Github CLI, an open-source command line tool that enables GitHub on your terminal.
- [Github Actions](https://cheatsheets.zip/github-actions.html): A quick reference to Github Actions for the automation of software workflows, allowing developers to build, test, and deploy code right from their GitHub repositories.
...
- [Alpine Linux](https://cheatsheets.zip/alpine-linux.html): A comprehensive cheatsheet for Alpine Linux, covering package management, system administration, networking, and more. Alpine Linux is a security-oriented, lightweight Linux distribution based on musl libc and busybox.
...
- [GnuPG](https://cheatsheets.zip/gnupg.html): A cheatsheet for GnuPG, the encryption and signing software.
- [Nginx](https://cheatsheets.zip/nginx.html): nginx quick reference cheat sheet
- [Telnet](https://cheatsheets.zip/telnet.html): This cheat sheet is intended to be a quick reminder for the main concepts involved in using the command line program telnet and assumes you already understand its usage.
- [Nmap](https://cheatsheets.zip/nmap.html): The [Nmap](https://nmap.org/) cheat sheet is a one-page reference sheet for the famous Network Mapper tool.
- [Systemd](https://cheatsheets.zip/systemd.html): systemd is the init system and service manager used by most modern Linux distributions.
- [SDKMAN!](https://cheatsheets.zip/sdkman.html): This cheatsheet provides the most commonly used SDKMAN! command line instructions
...
- [OpenSSL](https://cheatsheets.zip/openssl.html): This is a reference of commands to use to interact with electronic certificates
...
- [Matplotlib](https://cheatsheets.zip/matplotlib.html): [Matplotlib](https://matplotlib.org/) is a comprehensive library for creating static, animated, and interactive plots in Python.  
...
- [Pandas](https://cheatsheets.zip/pandas.html): [Pandas](https://pandas.pydata.org/) is a powerful data analysis and manipulation library for Python. This cheat sheet is a quick reference for Pandas beginners.
...
- [Zed](https://cheatsheets.zip/zed.html): A visual cheat-sheet for the 50 keyboard shortcuts found in the Zed text editor.
- [Unreal Engine](https://cheatsheets.zip/unreal-engine.html): A visual cheat-sheet for many keyboard shortcuts found in Unreal Engine 5
- [Gnome Desktop](https://cheatsheets.zip/gnome-desktop.html): A visual cheat-sheet for Gnome Desktop
...
- [Minecraft Bedrock Edition](https://cheatsheets.zip/minecraft-bedrock.html): A comprehensive reference for Minecraft Bedrock Edition (1.20.x) commands.
- [Minecraft Java Edition](https://cheatsheets.zip/minecraft-java.html): A comprehensive reference for Minecraft Java Edition (1.20.x) commands.
...
- [n8n](https://cheatsheets.zip/n8n.html): A quick reference for n8n workflow automation, covering expressions, built-in variables, core nodes, Code node patterns, error handling, and the CLI.
- [SBTI](https://cheatsheets.zip/sbti.html): SBTI 备忘单，快速了解这套娱乐人格测试的玩法、记分逻辑、15 个维度和 27 个结果代码。
- [ColorScreen](https://cheatsheets.zip/colorscreen.html): A quick reference collection of full-screen color pages, monitor tests, prank screens, screensavers, and timers.
- [GoSpinWheel](https://cheatsheets.zip/gospinwheel.html): Quick-reference cheatsheet for GoSpinWheel — a modern random wheel spinner, name picker, and decision maker.
- [Tensorflow](https://cheatsheets.zip/tensorflow.html): This is a quick reference list of cheat sheets for Tensorflow. See also [Tensorflow website](https://tensorflow.org/).
- [NetworkPorts](https://cheatsheets.zip/networkports.html): A network ports cheat sheet with non-exhaustive list of ports used according to their field of application.
- [Conventional Commits](https://cheatsheets.zip/conventional-commits.html): A cheat sheet of the Conventional Commits and Conventional Comments standards
